            ...
            <form method="post">
                ...
                <div class="mb-5">
                    <flux:input label="Section Title" name="section_name" required autofocus type="text"
                        placeholder="Enter Section Title" value="{{ $section->section_name }}" class="w-full mb-4" />


                    <flux:button icon="plus" type="submit">Edit Section</flux:button>
                </div>
            </form>
        </div>
    </div>
